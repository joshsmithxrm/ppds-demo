...
namespace PPDSDemo.Entities
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<PPDSDemo.Entities.Account> account_primary_contact
		{
			get
			{
				return this.GetRelatedEntities<PPDSDemo.Entities.Account>("account_primary_contact", null);
			}
			set
			{
				this.OnPropertyChanging("account_primary_contact");
				this.SetRelatedEntities<PPDSDemo.Entities.Account>("account_primary_contact", null, value);
		...
		public System.Collections.Generic.IEnumerable<PPDSDemo.Entities.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<PPDSDemo.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<PPDSDemo.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<PPDSDemo.Entities.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<PPDSDemo.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<PPDSDemo.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public PPDSDemo.Entities.Account contact_customer_accounts
		{
			get
			{
				return this.GetRelatedEntity<PPDSDemo.Entities.Account>("contact_customer_accounts", null);
			}
			set
			{
				this.OnPropertyChanging("contact_customer_accounts");
				this.SetRelatedEntity<PPDSDemo.Entities.Account>("contact_customer_accounts", null, value);
		...
		public PPDSDemo.Entities.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<PPDSDemo.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<PPDSDemo.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public PPDSDemo.Entities.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<PPDSDemo.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public PPDSDemo.Entities.Account msa_contact_managingpartner
		{
			get
			{
				return this.GetRelatedEntity<PPDSDemo.Entities.Account>("msa_contact_managingpartner", null);
			}
			set
			{
				this.OnPropertyChanging("msa_contact_managingpartner");
				this.SetRelatedEntity<PPDSDemo.Entities.Account>("msa_contact_managingpartner", null, value);
